...
def main():
    ...
    if args.do_eval and args.local_rank in [-1, 0]:
        ...
        model = model_class.from_pretrained(model_class, pretrained_model_name_or_path=args.model_name_or_path, config=config, model_params=model_params, force_download=True)
        model.to(args.device)
