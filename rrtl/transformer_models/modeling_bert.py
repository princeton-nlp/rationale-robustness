...
"""
Code taken and modified from: https://github.com/bhargaviparanjape/explainable_qa/blob/master/information_bottleneck/modeling_bert.py
"""
...
class BertModel(BertPreTrainedModel):
    ...
    def forward(self, input_ids=None, attention_mask=None, token_type_ids=None, position_ids=None,
        ...
        # TODO: Changes to the attention mask to support floating point support to be made here
        # There may need to be a temperature hyperparameter as well to support how much log scaling needs to be done
        #extended_attention_mask = extended_attention_mask.to(dtype=next(self.parameters()).dtype)  # fp16 compatibility
        extended_attention_mask = extended_attention_mask.to(input_ids.device)  # fp16 compatibility
        extended_attention_mask = torch.log(extended_attention_mask.float() + 1e-8) # Watch compatibility with fp16
